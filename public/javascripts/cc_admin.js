...
var socketCC = io.connect("https://wim.choum.net"+'/ccAdmin');
...
//	console.log("rep = ", rep);
	...
	if(submission.customQuestion.allResponses[index].hasFile == true ||
	   ["true","single","multi"].includes(submission.customQuestion.allResponses[index].hasFile)) {
	    ...
	    fileInfo.innerHTML = "<table><tr><td>Fichier : </td><td style='padding-left: 10px;'  ><a target='blank' class='fileName' style='color:blue' href='filePerso/"+currentQuestionOfCC.id+"/"+index+"/"+currentStudent.id+"/"+file.fileName+"'></a></td></tr>"+
		"<tr><td>Hash md5 : </td><td  style='padding-left: 10px;' class='hash'></td></tr>";
